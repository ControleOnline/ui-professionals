---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-professionals, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-professionals`.
...
- Checkout local: `app-community/modules/controleonline/ui-professionals`
